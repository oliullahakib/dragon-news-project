...
const RightAside = () => {
    return (
        <div>
            <div className="loginWith space-y-3">
                <h2 className='text-2xl font-bold mb-7'>Login With</h2>
                {/* Google */}
                <button className="btn border-0 w-full bg-white text-blue-300 outline outline-blue-300 ">
                ...
                {/* GitHub */}
                <button className="btn bg-white w-full text-black border-0 outline">
            ...
            <div className="find-us mt-8">
                ...
                <div className="join join-vertical bg-white w-full">
                    <button className="btn join-item bg-white py-6"> 
                         ...
                         Facebook</button>
                    <button className="btn join-item bg-white py-6"> <FaTwitter></FaTwitter> Twitter</button>
                    <button className="btn join-item bg-white py-6"> <FaInstagram/> Instagram </button>
                </div>
            </div>
